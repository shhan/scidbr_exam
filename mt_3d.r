...
# when not working getHdf function, debug with debug_getHdf_modir.R
# check MODISserverOrder <- c('LPDAAC', 'LAADS'); if server is LAADS, it doesn't work.
...
# gdal_translate(src_dataset = "SCIDB:array=MOD13A3[t,2004-04-01]", dst_dataset = "mod.tif" , of = "GTiff")
